...
import 'package:flutter_app_learn/src/bloc_app/screens/flutter_easyrefresh/sample_list_item.dart';
import 'package:flutter_easyrefresh/easy_refresh.dart';

class FlutterEasyRefreshScreen extends StatefulWidget {
  FlutterEasyRefreshScreen({Key key}) : super(key: key);

  @override
  _FlutterEasyRefreshScreenState createState() =>
      _FlutterEasyRefreshScreenState();
}

class _FlutterEasyRefreshScreenState extends State<FlutterEasyRefreshScreen> {
  // 总数
  int _count = 20;
