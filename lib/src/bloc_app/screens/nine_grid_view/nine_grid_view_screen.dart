...
class NineGridViewScreen extends StatefulWidget {
  @override
  _NineGridViewScreenState createState() => _NineGridViewScreenState();
}

class _NineGridViewScreenState extends State<NineGridViewScreen> {
      ...
      return Container(
        ...
        child: NineGridView(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ImageUtil.getWidget(bean.middlePath);
          },
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            NavigatorUtil.pushFromRight(
                                context, Routes.singlePictureScreen);
                          },
                        )),
                  ]),
        ],
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          NavigatorUtil.pushFromRight(context, Routes.dragSortScreen);
        },
      ),
    );
  }
